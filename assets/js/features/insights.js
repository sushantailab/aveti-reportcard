...
function renderClassInsights(data){
  ...
  show(`
    ...
    <div class="insight-report exact-insight-report">
      <div class="insight-print-head"><img class="insight-report-logo" alt="Aveti Learning Tuition Center logo" src="assets/images/aveti-logo.png"><div><div class="eyebrow">Aveti Learning Tuition Center</div><h1>Class Insights —<br>Student Performance Report</h1></div><button class="insight-print-button" onclick="window.print()">🖨 Print / Save as PDF</button></div>
