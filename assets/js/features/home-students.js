...
window.archiveStudent = async (id,name)=>{
  if(!confirm('Archive '+name+'? Their record and past marks will be hidden but recoverable by the Master Admin.')) return;
  await DB.archiveStudent(id); resultsCache.clear(); roster();
};
